...
void test_s32_mod(s32 d) {
    ...
    foo(((sp8 & 1) ^ temp_r3) - temp_r3);
    foo(sp8 % 3);
    foo(M2C_ERROR(/* unknown instruction: rotlwi $r0, $r0, 0x2 */) + ((u32) d >> 0x1FU));
    foo(sp8 % 5);
    foo(sp8 % 6);
    foo(sp8 % 7);
    foo(M2C_ERROR(/* unknown instruction: rotlwi $r0, $r0, 0x3 */) + ((u32) d >> 0x1FU));
    foo(sp8 % 9);
    foo(sp8 % 10);
    foo(sp8 % 11);
    foo(sp8 % 12);
    ...
    foo(sp8 % 14);
    foo(sp8 % 15);
    foo(M2C_ERROR(/* unknown instruction: rotlwi $r0, $r0, 0x4 */) + ((u32) d >> 0x1FU));
    foo(sp8 % 17);
    foo(sp8 % 18);
    foo(sp8 % 19);
    foo(sp8 % 20);
    ...
    foo(sp8 % 30);
    foo(sp8 % 31);
    foo(M2C_ERROR(/* unknown instruction: rotlwi $r0, $r0, 0x5 */) + ((u32) d >> 0x1FU));
    foo(sp8 % 33);
    foo(sp8 % 100);
    foo(sp8 % 255);
    foo(sp8 % 360);
    ...
    foo(sp8 % 10000000);
    foo(sp8 % 100000000);
    temp_r3_2 = sp8 / 1073741822;
    foo(sp8 - ((temp_r3_2 + (temp_r3_2 >> 0x1FU)) * 0x3FFFFFFE));
    temp_r3_3 = sp8 / 1073741822;
    foo(sp8 - ((temp_r3_3 + (temp_r3_3 >> 0x1FU)) * 0x3FFFFFFF));
    foo(M2C_ERROR(/* unknown instruction: rotlwi $r0, $r0, 0x1e */) + ((u32) d >> 0x1FU));
    temp_r3_4 = sp8 / 1073741824;
    foo(sp8 - ((temp_r3_4 + (temp_r3_4 >> 0x1FU)) * 0x40000001));
    temp_r3_5 = sp8 / 2147483648;
    foo(sp8 - ((temp_r3_5 + (temp_r3_5 >> 0x1FU)) * 0x7FFFFFFD));
    temp_r3_6 = sp8 / 2147483645;
    foo(sp8 - ((temp_r3_6 + (temp_r3_6 >> 0x1FU)) * 0x7FFFFFFE));
    temp_r3_7 = sp8 / 2147483648;
    foo(sp8 - ((temp_r3_7 + (temp_r3_7 >> 0x1FU)) * 0x7FFFFFFF));
    foo(sp8 % 2147483648);
    temp_r3_8 = sp8 / 715827883;
    foo(sp8 - ((temp_r3_8 + (temp_r3_8 >> 0x1FU)) * 0x80000001));
    temp_r3_9 = (s32) (MULT_HI(0x7FFFFFFD, sp8) - sp8) >> 0x1E;
    foo(sp8 - ((temp_r3_9 + ((u32) temp_r3_9 >> 0x1FU)) * 0x80000002));
    temp_r0 = (s32) MULT_HI(0x99999999, sp8) >> 2;
    foo(sp8 - ((temp_r0 + ((u32) temp_r0 >> 0x1FU)) * -0xA));
    temp_r0_2 = (s32) (MULT_HI(0x6DB6DB6D, sp8) - sp8) >> 2;
    foo(sp8 - ((temp_r0_2 + ((u32) temp_r0_2 >> 0x1FU)) * -7));
    temp_r0_3 = (s32) MULT_HI(0x99999999, sp8) >> 1;
    foo(sp8 - ((temp_r0_3 + ((u32) temp_r0_3 >> 0x1FU)) * -5));
    temp_r0_4 = (s32) ((sp8 / 2) - sp8) >> 1;
    foo(sp8 - ((temp_r0_4 + ((u32) temp_r0_4 >> 0x1FU)) * -4));
    temp_r0_5 = (s32) ((sp8 / 3) - sp8) >> 1;
    foo(sp8 - ((temp_r0_5 + ((u32) temp_r0_5 >> 0x1FU)) * -3));
    temp_r0_6 = (sp8 / 2) - sp8;
    foo(sp8 - ((temp_r0_6 + (temp_r0_6 >> 0x1FU)) * -2));
    foo(sp8 % -65537);
}
