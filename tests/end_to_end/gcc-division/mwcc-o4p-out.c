...
void test_s8(s8 c) {
    ...
    temp_r0 = (s8) (u8) sp8;
    temp_r0_2 = (MULT_HI(0x92492493, temp_r0) + temp_r0) >> 2;
    func_00400090(temp_r0_2 + ((u32) temp_r0_2 >> 0x1FU));
    func_00400090((s8) (u8) sp8 / 10);
    func_00400090((s8) (u8) sp8 / 100);
    temp_r0_3 = (s8) (u8) sp8;
    temp_r0_4 = (MULT_HI(0x80808081, temp_r0_3) + temp_r0_3) >> 7;
    ...
    func_00400090((s8) (u8) sp8 % 5);
    temp_r4_2 = (s8) (u8) sp8;
    temp_r0_5 = (MULT_HI(0x92492493, temp_r4_2) + temp_r4_2) >> 2;
    func_00400090(temp_r4_2 - ((temp_r0_5 + ((u32) temp_r0_5 >> 0x1FU)) * 7));
    func_00400090((s8) (u8) sp8 % 10);
    func_00400090((s8) (u8) sp8 % 100);
    temp_r4_3 = (s8) (u8) sp8;
    temp_r0_6 = (MULT_HI(0x80808081, temp_r4_3) + temp_r4_3) >> 7;
...
void test_s32_div(s32 d) {
    ...
    temp_r0_2 = (MULT_HI(0x92492493, sp8) + sp8) >> 3;
    func_00400090(temp_r0_2 + ((u32) temp_r0_2 >> 0x1FU));
    temp_r0_3 = (MULT_HI(0x88888889, sp8) + sp8) >> 3;
    func_00400090(temp_r0_3 + ((u32) temp_r0_3 >> 0x1FU));
    ...
    temp_r0_11 = (MULT_HI(0x80000005, sp8) + sp8) >> 0x1D;
    func_00400090(temp_r0_11 + ((u32) temp_r0_11 >> 0x1FU));
    temp_r0_12 = (MULT_HI(0x80000003, sp8) + sp8) >> 0x1D;
    ...
    temp_r0_15 = (MULT_HI(0x80000003, sp8) + sp8) >> 0x1E;
    ...
    temp_r0_18 = (MULT_HI(0x7FFFFFFD, sp8) - sp8) >> 0x1E;
    func_00400090(temp_r0_18 + ((u32) temp_r0_18 >> 0x1FU));
    temp_r0_19 = MULT_HI(0x99999999, sp8) >> 2;
    func_00400090(temp_r0_19 + ((u32) temp_r0_19 >> 0x1FU));
    temp_r0_20 = (MULT_HI(0x6DB6DB6D, sp8) - sp8) >> 2;
    func_00400090(temp_r0_20 + ((u32) temp_r0_20 >> 0x1FU));
    temp_r0_21 = MULT_HI(0x99999999, sp8) >> 1;
    func_00400090(temp_r0_21 + ((u32) temp_r0_21 >> 0x1FU));
    func_00400090((u32) -(sp8 / 4));
    temp_r0_22 = (MULT_HI(0x55555555, sp8) - sp8) >> 1;
...
void test_s32_mod(s32 d) {
    ...
    temp_r3 = (MULT_HI(0x80000003, sp8) + sp8) >> 0x1D;
    ...
    temp_r3_2 = (MULT_HI(0x80000003, sp8) + sp8) >> 0x1E;
...
void test_u32_div(u32 u) {
    ...
    func_00400090((((sp8 - temp_r3) >> 1U) + temp_r3) >> 2U);
    ...
    func_00400090((((sp8 - temp_r3_2) >> 1U) + temp_r3_2) >> 3U);
    func_00400090(sp8 / 15);
    func_00400090(sp8 >> 4U);
    func_00400090(sp8 / 17);
    func_00400090(sp8 / 18);
    temp_r3_3 = MULTU_HI(0xAF286BCB, sp8);
    func_00400090((((sp8 - temp_r3_3) >> 1U) + temp_r3_3) >> 4U);
    func_00400090(sp8 / 20);
    temp_r3_4 = MULTU_HI(0x86186187, sp8);
    func_00400090((((sp8 - temp_r3_4) >> 1U) + temp_r3_4) >> 4U);
    func_00400090(sp8 / 22);
    ...
    func_00400090((((sp8 - temp_r3_5) >> 1U) + temp_r3_5) >> 4U);
    temp_r3_6 = MULTU_HI(0x24924925, sp8);
    func_00400090((((sp8 - temp_r3_6) >> 1U) + temp_r3_6) >> 4U);
    func_00400090(sp8 / 29);
    func_00400090(sp8 / 30);
    temp_r3_7 = MULTU_HI(0x08421085, sp8);
    func_00400090((((sp8 - temp_r3_7) >> 1U) + temp_r3_7) >> 4U);
    func_00400090(sp8 >> 5U);
    func_00400090(sp8 / 33);
    func_00400090(sp8 / 100);
    func_00400090(sp8 / 255);
    temp_r3_8 = MULTU_HI(0x6C16C16D, sp8);
    func_00400090((((sp8 - temp_r3_8) >> 1U) + temp_r3_8) >> 8U);
    func_00400090(sp8 / 1000);
    func_00400090(sp8 / 10000);
    temp_r3_9 = MULTU_HI(0x4F8B588F, sp8);
    func_00400090((((sp8 - temp_r3_9) >> 1U) + temp_r3_9) >> 0x10U);
    func_00400090(sp8 / 1000000);
    func_00400090(sp8 / 10000000);
    func_00400090(sp8 / 100000000);
    func_00400090(sp8 >> 0x1EU);
    func_00400090(MULTU_HI(-3, sp8) >> 0x1EU);
    temp_r3_10 = MULTU_HI(5, sp8);
    func_00400090((((sp8 - temp_r3_10) >> 1U) + temp_r3_10) >> 0x1EU);
    temp_r3_11 = MULTU_HI(3, sp8);
    func_00400090((((sp8 - temp_r3_11) >> 1U) + temp_r3_11) >> 0x1EU);
    func_00400090(MULTU_HI(2, sp8));
    temp_r3_12 = MULTU_HI(-3, sp8);
    func_00400090((((sp8 - temp_r3_12) >> 1U) + temp_r3_12) >> 0x1FU);
    temp_r3_13 = MULTU_HI(3, sp8);
    func_00400090((((sp8 - temp_r3_13) >> 1U) + temp_r3_13) >> 0x1FU);
