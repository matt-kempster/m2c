...
void test_s32_div(s32 d) {
    ...
    func_00400090(sp8 / 28);
    func_00400090(sp8 / 29);
    func_00400090(sp8 / 30);
    func_00400090(sp8 / 31);
    ...
    func_00400090(temp_r0 + (temp_r0 >> 0x1FU));
    temp_r0_2 = sp8 / 1073741822;
    func_00400090(temp_r0_2 + (temp_r0_2 >> 0x1FU));
...
void test_s32_mod(s32 d) {
    ...
    func_00400090(sp8 % 100000000);
    temp_r0 = sp8 / 1073741822;
    func_00400090(sp8 - ((temp_r0 + (temp_r0 >> 0x1FU)) * 0x3FFFFFFE));
    temp_r3 = sp8 / 1073741822;
    func_00400090(sp8 - ((temp_r3 + (temp_r3 >> 0x1FU)) * 0x3FFFFFFF));
    ...
    func_00400090(sp8 - ((temp_r0_6 + ((u32) temp_r0_6 >> 0x1FU)) * -0xA));
