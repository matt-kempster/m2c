...
.global test
test:
/* 00000000 00000000  88 00 00 00 */	lbz r0, a@l(r0)
...
/* 00000010 00000010  88 00 00 00 */	lbz r0, b@l(r0)
/* 00000014 00000014  90 03 00 04 */	stw r0, 4(r3)
/* 00000018 00000018  A8 00 00 00 */	lha r0, c@l(r0)
/* 0000001C 0000001C  90 03 00 08 */	stw r0, 8(r3)
/* 00000020 00000020  A0 00 00 00 */	lhz r0, d@l(r0)
/* 00000024 00000024  90 03 00 0C */	stw r0, 0xc(r3)
/* 00000028 00000028  80 00 00 00 */	lwz r0, e@l(r0)
/* 0000002C 0000002C  90 03 00 10 */	stw r0, 0x10(r3)
/* 00000030 00000030  80 00 00 00 */	lwz r0, f@l(r0)
