...
s32 test(s32 arg0, s32 arg1, s32 arg2, s32 arg3) {
    ...
    sp20 = temp_t7;
    phi_t0 = temp_t7;
    if ((phi_s0 != 0) || (temp_t7 != 0) || (temp_v0 = func_00400090(temp_t7), phi_a2 = arg2, phi_t0 = temp_v0, (temp_v0 != 0)) || (phi_s0 = 2, (arg3 != 0))) {
        phi_v1_2 = 1;
    } else {
        phi_v1_2 = -2;
        if (arg0 != 0) {
    ...
    if ((phi_s0 != 0) && (phi_t0 != 0)) {
        phi_s0 += phi_t0;
        sp24 = phi_v1_3;
        temp_v0_2 = func_00400090(phi_s0);
        phi_v1_3 = phi_v1_3;
        phi_t0 = temp_v0_2;
        if ((temp_v0_2 != 0) && (arg3 != 0)) {
            if (phi_v1_3 < 5) {
                do {
                    temp_t3 = (phi_v1_3 + 1) * 2;
                    phi_v1_3 = temp_t3;
                } while (temp_t3 < 5);
            }
            phi_v1_3 += 5;
