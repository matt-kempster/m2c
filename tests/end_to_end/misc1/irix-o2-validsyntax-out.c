...
extern s32 (*func_00400140)(MIPS2C_UNK, MIPS2C_UNK, s32, MIPS2C_UNK, s32);
extern MIPS2C_UNK (*func_00400158)(MIPS2C_UNK32, s32, s32);
...
s32 test(s32 arg0, MIPS2C_UNK arg1) {
    ...
    sp2C = temp_a2;
    sp24 = MIPS2C_FIELD(temp_v0, MIPS2C_UNK32 *, 0x8);
